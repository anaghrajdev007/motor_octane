      ...
      <body id="page-top">
        ...
        <div id="wrapper">
          ...
          <ul className={style} id="accordionSidebar">
            ...
            {/* <!-- Nav Item - Pages-Mobile Collapse Menu --> */}
            <li className="nav-item">
              <a
                className="nav-link collapsed"
                href="#"
            ...
            {/* <!-- Nav Item - Pages-Web Collapse Menu --> */}
            <li className="nav-item">
              <a
                className="nav-link collapsed"
                href="#"
              ...
              >
                <div className="bg-white py-2 collapse-inner rounded">
                  ...
                  <div className="collapse-divider"></div>
                  <h6 className="collapse-header">Other Pages:</h6>
                  <a className="collapse-item" href="#Idot">
                    Other Page
                  </a>
                  <a className="collapse-item" href="#AbhiNahiBanaHai">
                    Other Pages
                  </a>
                </div>
              </div>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>01-01-2001</td>
                            <td>&#8377; 1500</td>
                            <td><i class='bx bx-desktop' ></i></td>
                          </tr>
                        </tbody>
                      </table>
                      {/* End of table for data-Consultation */}
                      {/* <!-- Card Body --> */}
                      <div className="card-body">
            ...
            <footer className="sticky-footer bg-white">
              <div className="container my-auto">
                <div className="copyright text-center my-auto">
                  <span>Copyright &copy; BRANDKLIN</span>
                </div>
              </div>
            </footer>
            {/* <!-- End of Footer --> */}
